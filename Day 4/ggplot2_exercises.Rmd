...
These exercises will give you some introductory experience with the `ggplot2`. Start by loading the `dplyr` and `ggplot2` library as well as the `murders` and `heights` data.
