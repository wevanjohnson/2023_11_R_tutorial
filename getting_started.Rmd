...
R is not a programming language like C or Java. It was not created by software engineers for software development. Instead, it was developed by statisticians as an interactive environment for data analysis. A history of R is summarized: A Brief History of S^[https://citeseerx.ist.psu.edu/viewdoc/download?rep=rep1&type=pdf&doi=10.1.1.131.1428]. 

![](img/r_rstudio.png){height=50%}

## Why R?
The __interactivity__ of R (more later), is an indispensable feature in data science because, as you will soon learn, the ability to quickly explore data is a necessity for success in this field. 

![](img/RInterface.JPG){height=40%}
...
## Why R?
If you are an expert programmer, you should not expect R to follow the conventions you are used to. If you are patient, you will come to appreciate the unequal power of R when it comes to data analysis and, specifically, data visualization.
...
1. R is free and open source: [https://opensource.org/history](https://opensource.org/history).
