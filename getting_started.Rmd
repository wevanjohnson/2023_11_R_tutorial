...
## Installing R packages
In RStudio, you can navigate to the __Tools__ tab and select install packages. We can then load the package into our R sessions using the `library` function:
