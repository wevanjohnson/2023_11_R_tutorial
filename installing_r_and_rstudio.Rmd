...
```{r, echo=FALSE, out.width = "45%",  out.extra=""}
knitr::include_graphics(mac_screenshots[6:9])
```

## Installing R (Mac)
```{r, echo=FALSE, out.width = "45%",  out.extra=""}
knitr::include_graphics(mac_screenshots[10:13])
```
...
```{r, echo=FALSE}
knitr::include_graphics(mac_screenshots[21]) 
```
...
```{r, echo=FALSE, out.width = "45%",  out.extra=""}
knitr::include_graphics(mac_screenshots[22:23]) 
```
